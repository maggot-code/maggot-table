<!--
 * @FilePath: \maggot-table\packages\mg-column-number\src\mg-column-number.vue
 * @Author: maggot-code
...
-->
<template>
    <el-input-number class="mg-column-number" :value="rowValue" v-bind="options" @input="toInput"></el-input-number>
</template>
